      ...
      >
        ...
        >
          <path
            id="HI"
            className="state"
            datainfo="<div>State: Hawaii</div><div>Capital: Honolulu</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="AK"
            className="state"
            datainfo="<div>State: Alaska</div><div>Capital: Juneau</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="FL"
            className="state"
            datainfo="<div>State: Florida</div><div>Capital: Tallahassee</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="SC"
            className="state"
            datainfo="<div>State: South Carolina</div><div>Capital: Columbia</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="GA"
            className="state"
            datainfo="<div>State: Georgia</div><div>Capital: Atlanta</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="AL"
            className="state"
            datainfo="<div>State: Alabama</div><div>Capital: Montgomery</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="NC"
            className="state"
            datainfo="<div>State: North Carolina</div><div>Capital: Raleigh</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="TN"
            className="state"
            datainfo="<div>State: Tennessee</div><div>Capital: Nashville</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="RI"
            className="state"
            datainfo="<div>State: Rhode Island</div><div>Capital: Providence</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="CT"
            className="state"
            datainfo="<div>State: Connecticut</div><div>Capital: Hartford</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="MA"
            className="state"
            datainfo="<div>State: Massachusetts</div><div>Capital: Boston</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="ME"
            className="state"
            datainfo="<div>State: Maine</div><div>Capital: Augusta</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="NH"
            className="state"
            datainfo="<div>State: New Hampshire</div><div>Capital: Concord</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="VT"
            className="state"
            datainfo="<div>State: Vermont</div><div>Capital: Montpelier</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="NY"
            className="state"
            datainfo="<div>State: New York</div><div>Capital: Albany</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="NJ"
            className="state"
            datainfo="<div>State: New Jersey</div><div>Capital: Trenton</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="PA"
            className="state"
            datainfo="<div>State: Pennsylvania</div><div>Capital: Harrisburg</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="DE"
            className="state"
            datainfo="<div>State: Delaware</div><div>Capital: Dover</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="MD"
            className="state"
            datainfo="<div>State: Maryland</div><div>Capital: Annapolis</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="WV"
            className="state"
            datainfo="<div>State: West Virginia</div><div>Capital: Charleston</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="KY"
            className="state"
            datainfo="<div>State: Kentucky</div><div>Capital: Frankfort</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="OH"
            className="state"
            datainfo="<div>State: Ohio</div><div>Capital: Columbus</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="MT"
            className="state"
            datainfo="<div>State: Montana</div><div>Capital: Helena</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="ID"
            className="state"
            datainfo="<div>State: Idaho</div><div>Capital: Boise</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="WA"
            className="state"
            datainfo="<div>State: Washington</div><div>Capital: Olympia</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="TX"
            className="state"
            datainfo="<div>State: Texas</div><div>Capital: Austin</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="CA"
            className="state"
            datainfo="<div>State: California</div><div>Capital: Sacramento</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="AZ"
            className="state"
            datainfo="<div>State: Arizona</div><div>Capital: Phoenix</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="NV"
            className="state"
            datainfo="<div>State: Nevada</div><div>Capital: Carson City</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="UT"
            className="state"
            datainfo="<div>State: Utah</div><div>Capital: Salt Lake City</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="CO"
            className="state"
            datainfo="<div>State: Colorado</div><div>Capital: Denver</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="NM"
            className="state"
            datainfo="<div>State: New Mexico</div><div>Capital: Santa Fe</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="OR"
            className="state"
            datainfo="<div>State: Oregon</div><div>Capital: Salem</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="ND"
            className="state"
            datainfo="<div>State: North Dakota</div><div>Capital: Bismarck</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="SD"
            className="state"
            datainfo="<div>State: South Dakota</div><div>Capital: Pierre</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="NE"
            className="state"
            datainfo="<div>State: Nebraska</div><div>Capital: Lincoln</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="IA"
            className="state"
            datainfo="<div>State: Iowa</div><div>Capital: Des Moines</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="MS"
            className="state"
            datainfo="<div>State: Mississippi</div><div>Capital: Jackson</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="IN"
            className="state"
            datainfo="<div>State: Indiana</div><div>Capital: Indianapolis</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="IL"
            className="state"
            datainfo="<div>State: Illinois</div><div>Capital: Springfield</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="MN"
            className="state"
            datainfo="<div>State: Minnesota</div><div>Capital: Saint Paul</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="WI"
            className="state"
            datainfo="<div>State: Wisconsin</div><div>Capital: Madison</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="MO"
            className="state"
            datainfo="<div>State: Missouri</div><div>Capital: Jefferson City</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="AR"
            className="state"
            datainfo="<div>State: Arkansas</div><div>Capital: Little Rock</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="OK"
            className="state"
            datainfo="<div>State: Oklahoma</div><div>Capital: Oklahoma City</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="KS"
            className="state"
            datainfo="<div>State: Kansas</div><div>Capital: Topeka</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="LA"
            className="state"
            datainfo="<div>State: Louisiana</div><div>Capital: Baton Rouge</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <path
            id="VA"
            className="state"
            datainfo="<div>State: Virginia</div><div>Capital: Richmond</div>"
            fill="var(--mui-palette-text-secondary)"
            color="currentColor"
          ...
          <g id="DC">
            ...
            <circle
              id="circle60"
              datainfo="<div>Washington DC</div>"
              fill="var(--mui-palette-text-secondary)"
              color="currentColor"
        ...
        <path
          ...
          stroke="black"
          strokeWidth="2"
          d="M385,593 v55 l36,45 M174,525 h144 l67,68 h86 l53,54 v46"
        />
      </svg>
    </Container>
  );
